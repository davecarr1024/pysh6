    ...
    def test_optional(self):
        for result, expected in list[
            ...
            [
                ...
                (results.OptionalResult[int](0), results.OptionalResult[int](0)),
            ]
        ):
            with self.subTest(results=result, expected=expected):
                if expected is None:
    ...
    def test_multiple(self):
        for result, expected in list[
            ...
            [
                ...
                (results.OptionalResult[int](0), results.MultipleResults[int]([0])),
            ]
        ):
            with self.subTest(results=result, expected=expected):
                if expected is None:
    ...
    def test_named(self):
        for result, expected in list[
            ...
            [
                ...
                (results.OptionalResult[int](0), results.NamedResults[int]({"a": 0})),
            ]
        ):
            with self.subTest(results=result, expected=expected):
                if expected is None:
