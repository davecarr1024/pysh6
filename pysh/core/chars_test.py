...
class PositionTest(TestCase):
    def test_add(self):
        for pos, char, expected in list[
            tuple[chars.Position, chars.Char, chars.Position]
        ](
            [
                (
                    chars.Position(),
...
class StreamTest(TestCase):
    def test_load(self):
        for value, position, expected in list[
            tuple[str, Optional[chars.Position], chars.Stream]
        ](
            [
                (
                    "",
